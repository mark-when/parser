...
describe("regex indices", () => {
  ...
  test('edtf recurrence indices 1', () => {
    const matches = `2019-01-01 every 12 week days for 9 times: event title`.match(
      EDTF_START_REGEX
    );
  ...
  test('edtf recurrence indices 2', () => {
    const matches = `2019-01-01 / 2022-08-07 every 12 week days for 9 times: event title`.match(
      EDTF_START_REGEX
    );
  ...
  test('edtf recurrence indices 4', () => {
    const matches = `2019-01-01 / 2022-08-07 every 3 days for 3 days: event title`.match(
      EDTF_START_REGEX
    );
  ...
  test('edtf recurrence indices 4', () => {
    ...
    expect(matches![recurrence_edtfRecurrenceAmountXNotationMatchIndex]).toBe(" x50");
